    ...
    return (
        <>
            <div className="relative">
                ...
                <div className={`absolute right-0 w-[260px] overflow-hidden px-4 py-3 bg-white dark:bg-slate-700/70 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/40 dark:border-slate-700/30 transition-all duration-200 ${open ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-2 pointer-events-none'}`}>
                    <div className={`h-[40px] flex items-center justify-between mt-3`}>
                        <p className={`text-gray-800 dark:text-gray-100 text-[14px]`}>Bottle Sound Alerts</p>
                        <Switch state={bottleAlertEnabled} setState={setBottleAlertEnabled} />
                    </div>

                    <div className={`h-[40px] flex items-center justify-between mt-3`}>
                        <p className={`text-gray-500 dark:text-gray-200 text-[14px]`}>Application Alerts</p>
                        <Switch state={appAlerts} setState={setAppAlerts} />
                    </div>
                    ...
                    <button
                        ...
                        className="w-full mt-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-lg transition-colors"
                    >
                            Save
                        </button>
                </div>

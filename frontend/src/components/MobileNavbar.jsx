...
<div className="relative flex items-center justify-center w-9 h-9">
    ...
    <img
        src={page === "Hub" ? Account : Settings}
        className="relative z-10 w-6 h-6 dark:[filter:invert(1)_brightness(2)] [@media(max-width:199px)]:w-5 [@media(max-width:199px)]:h-5"
        alt={page === "Hub" ? 'Account icon' : 'Settings icon'}
    />
</div>
<p className="text-[12px] text-gray-900 dark:text-gray-100 [@media(max-width:199px)]:text-[10px]">
    {page === "Hub" ? "Account" : "Settings"}
</p>
...
<div className="relative flex items-center justify-center w-9 h-9">
    <span className="absolute inset-0 m-auto w-9 h-9 rounded-full bg-blue-500/8 dark:bg-white/6" />
    <img
        src={page === "Hub" ? Settings : Statistics}
        className="relative z-10 w-6 h-6 dark:[filter:invert(1)_brightness(2)] [@media(max-width:199px)]:w-5 [@media(max-width:199px)]:h-5"
        alt={page === "Hub" ? 'Settings icon' : 'Statistics icon'}
    />
</div>
<p className="text-[12px] text-gray-900 dark:text-gray-100 [@media(max-width:199px)]:text-[10px]">
    {page === "Hub" ? "Settings" : "Statistics"}
</p>

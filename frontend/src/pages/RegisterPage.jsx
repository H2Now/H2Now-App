...
function RegisterPage() {
    ...
    const handleRegisterSubmit = async (e) => {
        ...
        if (name.trim().length < 2) {
            setWarning("Name must be at least 2 characters long");
            setLoading(false);
            return;
        }
            ...
            <div className="relative w-full max-w-xs sm:max-w-md space-y-4 sm:space-y-8">
                <div className="bg-white/85 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 dark:border-slate-700/50 p-8 sm:p-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">Join H2Now and start your hydration journey</p>
                    </div>
                    ...
                    {/* Warning Message */}
                    {warning && (
                        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 px-4 py-3 rounded-lg mb-6">
                            <div className="flex">
                    ...
                    <form onSubmit={handleRegisterSubmit} noValidate className="space-y-5">
                        ...
                        <GoogleAuthButton text="Sign up with Google"></GoogleAuthButton>
